...
def main(cfg: DictConfig):
    ...
    for cam_id in cameras:
        ...
        for depth_frame in frames:
            ...
            # Negate X to match the horizontally flipped RGB convention
            # that the extrinsics were calibrated from.
            # This must happen AFTER the DLT projection (which needs unflipped X)
            # but BEFORE storing points for plane fitting.
            pts_3d[:, 0] = -pts_3d[:, 0]
